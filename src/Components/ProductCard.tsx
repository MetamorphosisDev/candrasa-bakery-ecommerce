                ...
                {pexelsImageList.map((product) =>
                    <div className="bg-white-theme p-3 rounded-xl flex flex-col gap-2.5">
                        ...
                        <div className="description flex justify-between items-center gap-2">
                            ...
                            <div className="shrink-0 overflow-hidden bg-purple rounded-[10px] p-2.5 md:p-3.5 group transition-all ease-in-out duration-200 hover:bg-orange-light hover:scale-102 cursor-pointer">
